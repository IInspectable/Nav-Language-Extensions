...
//==================================================
// HINWEIS: Diese Datei wurde am 24.01.2024 08:18:16
...
namespace Nav.Language.Tests {
	...
	public class ParseEmptyStringTests {
		...
		[Test]
		public void TestConcatGoToEdgeSyntax() {
			
        var concatGoToEdgeSyntax=Syntax.ParseConcatGoToEdge("");
            // Keyword
            Assert.That(concatGoToEdgeSyntax.Keyword.IsMissing, Is.True, "Das Token '{0}' sollte als 'fehlend' gekennzeichnet sein.", concatGoToEdgeSyntax.Keyword);
            Assert.That(concatGoToEdgeSyntax.Keyword.Extent.IsMissing, Is.True, "Extent des Token '{0}' sollte als 'fehlend' gekennzeichnet sein.", concatGoToEdgeSyntax.Keyword);
            // ConcatGoToEdgeSyntaxKeyword
            Assert.That(concatGoToEdgeSyntax.ConcatGoToEdgeKeyword.IsMissing, Is.True, "Das Token '{0}' sollte als 'fehlend' gekennzeichnet sein.", concatGoToEdgeSyntax.ConcatGoToEdgeKeyword);
            Assert.That(concatGoToEdgeSyntax.ConcatGoToEdgeKeyword.Extent.IsMissing, Is.True, "Extent des Token '{0}' sollte als 'fehlend' gekennzeichnet sein.", concatGoToEdgeSyntax.ConcatGoToEdgeKeyword);
		}
		...
		[Test]
		public void TestConcatModalEdgeSyntax() {
			
        var concatModalEdgeSyntax=Syntax.ParseConcatModalEdge("");
            // Keyword
            Assert.That(concatModalEdgeSyntax.Keyword.IsMissing, Is.True, "Das Token '{0}' sollte als 'fehlend' gekennzeichnet sein.", concatModalEdgeSyntax.Keyword);
            Assert.That(concatModalEdgeSyntax.Keyword.Extent.IsMissing, Is.True, "Extent des Token '{0}' sollte als 'fehlend' gekennzeichnet sein.", concatModalEdgeSyntax.Keyword);
            // ConcatModalEdgeKeyword
            Assert.That(concatModalEdgeSyntax.ConcatModalEdgeKeyword.IsMissing, Is.True, "Das Token '{0}' sollte als 'fehlend' gekennzeichnet sein.", concatModalEdgeSyntax.ConcatModalEdgeKeyword);
            Assert.That(concatModalEdgeSyntax.ConcatModalEdgeKeyword.Extent.IsMissing, Is.True, "Extent des Token '{0}' sollte als 'fehlend' gekennzeichnet sein.", concatModalEdgeSyntax.ConcatModalEdgeKeyword);
		}
		...
		[Test]
		public void TestConcatTransitionSyntax() {
