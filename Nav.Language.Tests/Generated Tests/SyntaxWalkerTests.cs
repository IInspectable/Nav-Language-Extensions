...
//==================================================
// HINWEIS: Diese Datei wurde am 24.01.2024 08:17:18
...
namespace Nav.Language.Tests {
	...
	public sealed class TestSyntaxNodeWalker: SyntaxNodeWalker {
		...
		public override bool WalkConcatGoToEdge(ConcatGoToEdgeSyntax concatGoToEdgeSyntax) { 
			MethodsCalled["WalkConcatGoToEdge"]=true;
			return true; 
		}
		public override void PostWalkConcatGoToEdge(ConcatGoToEdgeSyntax concatGoToEdgeSyntax) { 
			MethodsCalled["PostWalkConcatGoToEdge"]=true;
		}
		...
		public override bool WalkConcatModalEdge(ConcatModalEdgeSyntax concatModalEdgeSyntax) { 
			MethodsCalled["WalkConcatModalEdge"]=true;
			return true; 
		}
		public override void PostWalkConcatModalEdge(ConcatModalEdgeSyntax concatModalEdgeSyntax) { 
			MethodsCalled["PostWalkConcatModalEdge"]=true;
		}
		...
		public override bool WalkConcatTransition(ConcatTransitionSyntax concatTransitionSyntax) { 
			MethodsCalled["WalkConcatTransition"]=true;
			return true; 
		}
		public override void PostWalkConcatTransition(ConcatTransitionSyntax concatTransitionSyntax) { 
			MethodsCalled["PostWalkConcatTransition"]=true;
		}
	...
	public class SyntaxWalkerTests {
		...
		// ConcatGoToEdge
		[Test]
		public void TestWalkConcatGoToEdge() {
			Assert.That(MethodsCalled.ContainsKey("WalkConcatGoToEdge"), Is.True, "WalkConcatGoToEdge not called.");	
			Assert.That(MethodsCalled.ContainsKey("PostWalkConcatGoToEdge"), Is.True, "PostWalkConcatGoToEdge not called.");
		}
		// InitSourceNode
		[Test]
		...
		// ConcatModalEdge
		[Test]
		public void TestWalkConcatModalEdge() {
			Assert.That(MethodsCalled.ContainsKey("WalkConcatModalEdge"), Is.True, "WalkConcatModalEdge not called.");	
			Assert.That(MethodsCalled.ContainsKey("PostWalkConcatModalEdge"), Is.True, "PostWalkConcatModalEdge not called.");
		}
		// TaskDeclaration
		[Test]
		...
		// ConcatTransition
		[Test]
		public void TestWalkConcatTransition() {
			Assert.That(MethodsCalled.ContainsKey("WalkConcatTransition"), Is.True, "WalkConcatTransition not called.");	
			Assert.That(MethodsCalled.ContainsKey("PostWalkConcatTransition"), Is.True, "PostWalkConcatTransition not called.");
		}
		// IncludeDirective
		[Test]
