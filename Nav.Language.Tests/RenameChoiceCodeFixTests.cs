...
";            
            ...
            RenameChoiceCodeFix codeFix = new RenameChoiceCodeFix(orgCodeGenerationUnit, choiceNodeSymbol);

            Assert.That(codeFix.CanApplyFix(), Is.True);

            var textChanges = codeFix.GetTextChanges(newChoice, GetEditorSettings());
